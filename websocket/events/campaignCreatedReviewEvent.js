...
class CampaignCreatedReviewEvent extends CommonEvent {

    /**
     * name of event
     */
    name = 'campaignCreatedReviewEvent'
    /**
     ...
     */
    handle = async () => {
        return { newReview: this.event.newReview }
    }
}

module.exports = CampaignCreatedReviewEvent